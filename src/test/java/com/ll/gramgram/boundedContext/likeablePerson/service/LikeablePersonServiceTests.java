...
public class LikeablePersonServiceTests {
    ...
    @DisplayName("정렬 - 최신순")
    void t009() {
        List<LikeablePerson> likeablePeople = likeablePersonService.findByToInstaMember("1111", "", 0, 1);
        assertThat(likeablePeople)
                .isSortedAccordingTo(
                        Comparator.comparing(LikeablePerson::getId, Comparator.reverseOrder()));
    }
