...
public class LikeablePersonServiceTests {
    ...
    @Test
    @DisplayName("호감사유를 생성하면 알림생성 되는지 확인")
    void t009() throws Exception {
        ...
        // 알림 생성 되었는지 확인
        assertThat(
                notificationService.findByToInstaMember(likeablePersonToBts.getToInstaMember()).isEmpty()
        ).isEqualTo(false);
    }

    @Test
    @DisplayName("호감사유를 변경하면 알림생성 되는지 확인")
    void t010() throws Exception {
        ...
        // 알림 생성 되었는지 확인
        assertThat(
                notificationService.findByToInstaMember(likeablePersonToBts.getToInstaMember())
                        .size()
        ).isEqualTo(2);
    }
}
